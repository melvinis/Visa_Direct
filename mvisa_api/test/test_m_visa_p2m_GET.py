...
class TestMVisaCashIn(BaseTest):
    ...
    def simulate_cash_out_timeout(self):
        base_uri = 'visadirect/'
        ...
        response = self.visa_api_client.do_mutual_auth_request(base_uri + resource_path,
                                                               ...
                                                               'MVisa With Timeout', 'post', {'x-transaction-timeout-ms': "1"},
                                                                       stream=True)
        self.assertIsNotNone(response.content)
        return response

    def test_cashout_get(self):
        timeout_response = self.simulate_cash_out_timeout()
        resource_path_get_pull_funds = 'visadirect/mvisa/v1/merchantpushpayments/'
        ...
        self.assertTrue(response_code >= 200 and response_code <= 299,
                         "Get P2M transaction test failed")
