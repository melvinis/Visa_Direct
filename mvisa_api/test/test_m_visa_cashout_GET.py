...
class TestMVisaCashIn(BaseTest):
    ...
    def setUp(self):
        ...
        self.cash_out_request = json.loads('''{
    ...
    def test_cashout_get(self):
        ...
        resource_path_get_pull_funds = 'visadirect/mvisa/v1/cashoutpushpayments/'
        ...
        self.assertTrue(response_code >= 200 and response_code <= 299,
                         "Get Cash Out transaction test failed")
