...
**approval_code** | **str** | This field, if present, must contain the approvalCode from the original refund transaction. | [optional] 
...
**transmission_date_time** | **str** | This field must contain the transmissionDateTime from the original refund transaction. | 
